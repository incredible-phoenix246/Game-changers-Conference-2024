...
function MyComponent() {
  return (
    <section className="flex justify-center self-center z-[99] mx-auto items-center py-4 md:py-2 h-full md:h-[150px] md:-mt-[20px] w-full md:w-[70%] rounded-3xl shadow-2xl leading-[150%]">
